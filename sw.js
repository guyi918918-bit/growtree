...
// 文件名带构建号哈希（app.20260819a.js），部署后旧引用必然 404 → 强制加载新文件。
// 探测到新版本时自动激活并接管页面，无需用户手动删除重加。

const CACHE = 'growtree-shell-v23';
const SHELL = ['./', './index.html', './app.20260819a.js', './styles.20260819a.css', './manifest.json'];
