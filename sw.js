...
// 文件名带构建号哈希（app.20260818i.js），部署后旧引用必然 404 → 强制加载新文件。
// 探测到新版本时自动激活并接管页面，无需用户手动删除重加。

const CACHE = 'growtree-shell-v21';
const SHELL = ['./', './index.html', './app.20260818i.js', './styles.20260818i.css', './manifest.json'];
