    ...
    try {
        ...
        if (data && data.payload) {
            ...
            if (force || !state.data.lastSyncAt || (cloudUpdatedAt && cloudUpdatedAt > state.data.lastSyncAt)) {
                ...
                // 悦己享瘦数据快照，合并后如有变化需推回 iframe
                const yjxsBefore = JSON.stringify(state.data.yjxs || {});
                ...
                saveStateLocal();
                // 若悦己享瘦云端数据有更新，推回 iframe 使其即时生效
                if (JSON.stringify(state.data.yjxs || {}) !== yjxsBefore) {
                    pushYjxsToIframe();
                }
