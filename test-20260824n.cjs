...
const APP_JS = fs.readFileSync(path.join(ROOT, 'app.20260824n.js'), 'utf8');
...
if (swCache && parseInt(swCache[1], 10) === 80) ok('SW CACHE 已递增到 v80'); else no('SW CACHE 未递增');
...
// 9. 历史详情表格样式存在
const CSS = fs.readFileSync(path.join(ROOT, 'styles.20260824n.css'), 'utf8');
