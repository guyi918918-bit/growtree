...
function categoryItemsBody(mod) {
    ...
    return `
        <div class="card cat-block">
            ...
            })).join('') : '<div class="empty-state"><span class="emoji">📝</span>还没有打卡项，去「管理 → 批量管理」添加吧</div>'}
        </div>
    `;
}
...
function otherCategoryBody(cats, mode) {
    ...
    return `
        ...
        ${!groups.length ? '<div class="empty-state"><span class="emoji">📝</span>还没有打卡项，去「管理 → 批量管理」添加吧</div>' : ''}
    `;
}
