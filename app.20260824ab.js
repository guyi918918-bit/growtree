...
function renderFatlossPage(tab) {
    ...
    if (tab === 'fl-trend') return flRenderTrend();
    ...
    <div class="fl-overview">
        <div class="card">
            ...
            <div class="fl-section">
                <div class="fl-section-title"><span>📋 打卡记录</span><span>完成时间 · 体重</span></div>
                <div class="fl-history-list">${historyItems}</div>
            </div>
            <div class="fl-section">
                <div class="fl-section-title"><span>📐 阶梯进度</span><span>${totalSteps} 个阶梯</span></div>
...
function flRenderTrend() {
    return `
    <div class="fl-trend-page">
        <div class="card">
            <div class="fl-card-header"><div class="fl-card-title">📉 体重变化</div></div>
            <div class="fl-chart-wrap"><canvas id="flWeightChart"></canvas></div>
        </div>
        <div class="card">
            <div class="fl-card-header"><div class="fl-card-title">📉 围度变化</div></div>
            <div class="fl-chart-wrap"><canvas id="flCircChart"></canvas></div>
        </div>
    </div>`;
}
...
function flHandleCheckin() {
    ...
    if (inputWeight > current.target) { toast(`当前体重 ${inputWeight.toFixed(1)} 斤，目标 ${current.target.toFixed(1)} 斤，还需努力！`); return; }
