    ...
    return `<div class="eg-container">
        ...
        <header class="eg-header">
            ...
            <div class="eg-level-area">
                <div class="eg-level-badge" id="egLevelBadge">
                    <span class="eg-symbols" id="egLevelSymbols">⚓</span>
                    Lv.<span id="egLevelNumber">1</span>
                    <div class="eg-level-tooltip" id="egLevelTooltip">
                        <div class="eg-title">🏅 等级符号说明</div>
                        <div class="eg-row"><span class="eg-symbol">⚓</span><span class="eg-name">Anchor</span><span class="eg-level">1 级</span></div>
                        <div class="eg-row"><span class="eg-symbol">🧭</span><span class="eg-name">Compass</span><span class="eg-level">4 级</span></div>
                        <div class="eg-row"><span class="eg-symbol">⛵</span><span class="eg-name">Sail</span><span class="eg-level">16 级</span></div>
                        <div class="eg-row"><span class="eg-symbol">🌊</span><span class="eg-name">Wave</span><span class="eg-level">64 级</span></div>
                        <div class="eg-row"><span class="eg-symbol">🌍</span><span class="eg-name">Globe</span><span class="eg-level">256 级</span></div>
                        <div class="eg-row"><span class="eg-symbol">🌌</span><span class="eg-name">Galaxy</span><span class="eg-level">1024 级</span></div>
                        <div class="eg-divider"></div>
                        <div class="eg-row" style="justify-content:center; font-size:12px; color:var(--text-secondary);">
                            4个低级 = 1个高级 &nbsp;·&nbsp; <strong style="color:var(--accent);">🎯 满级999级</strong>
                        </div>
                        <div class="eg-footer">当前称号：<strong id="egTooltipTitle">Anchored 锚定</strong></div>
                    </div>
                </div>
        ...
        <div class="card tab-card sub-tab-card eg-tab-bar">
            <button class="tab-btn active" data-eg-tab="home">🏠 首页</button>
            <button class="tab-btn" data-eg-tab="achievements">🏆 成就</button>
            <button class="tab-btn" data-eg-tab="history">📜 历史</button>
        </div>

        <!-- ===== home 面板 ===== -->
        <div class="eg-panel active" id="egPanel-home">
            <!-- 今日冒险 -->
        ...
        <!-- ===== achievements 面板 ===== -->
        <div class="eg-panel" id="egPanel-achievements">
            <!-- 成就墙 + 今日数据 并排 -->
        ...
        <!-- ===== history 面板 ===== -->
        <div class="eg-panel" id="egPanel-history">
...
function initEnglishPlayground() {
            ...
            const tooltipTitle = document.getElementById('egTooltipTitle');
            ...
            function updateLevelDisplay() {
                ...
                tooltipTitle.textContent = getTitle(lv);
            }
            ...
            const levelTooltip = document.getElementById('egLevelTooltip');

            levelBadge.addEventListener('click', function(e) {
                e.stopPropagation();
                levelTooltip.classList.toggle('show');
            });

            // 仅绑定一次：重复渲染英语板块会重建 DOM，累计 document 监听会泄漏。
            // 用事件委托读取「当前」DOM 中的徽章与气泡，避免引用失效。
            if (!window.__egTipHandlerBound) {
                document.addEventListener('click', function(e) {
                    const badge = document.querySelector('.eg-level-badge');
                    const tip = document.querySelector('.eg-level-tooltip');
                    if (badge && tip && !badge.contains(e.target)) tip.classList.remove('show');
                });
                window.__egTipHandlerBound = true;
            }
