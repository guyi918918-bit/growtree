...
function renderEnglish() {
    return `<div class="eg-container">
            ...
            <div class="eg-level-area">
                <div class="eg-level-badge" id="egLevelBadge">
                    ...
                    <div class="eg-level-tooltip" id="egLevelTooltip">
                        ...
                        <div class="eg-row" style="justify-content:center; font-size:12px; color:#636e72;">
                            4个低级 = 1个高级 &nbsp;·&nbsp; <strong style="color:#fd79a8;">🎯 满级999级</strong>
                        </div>
        ...
        <div class="eg-panel" id="egPanel-achievements">
            <!-- 成就墙 -->
            <div class="eg-grid" style="margin-top:0;">
                <section class="eg-card">
