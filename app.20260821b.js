...
function initEnglishPlayground() {
            // 安全读取 localStorage：之前坏版本可能写入损坏 JSON，需容错防止整模块初始化崩溃
            ...
            function getMonthAchievements() {
                ...
                const data = safeParse('gt_eg_monthAchievements', {});
                if (!data[key]) {
            ...
            function getTodayStats() {
                let stats = safeParse('gt_eg_engTodayStats', {});
                if (stats.date !== today) {
            ...
            function addSearchHistory(query) {
                let history = safeParse('gt_eg_searchHistory', []);
            ...
            function addCopyHistory(zh, en, detailHtml) {
                let history = safeParse('gt_eg_copyHistory', []);
            ...
            function renderHistory() {
                ...
                const searchHistory = safeParse('gt_eg_searchHistory', []);
                const copyHistory = safeParse('gt_eg_copyHistory', []);
                ...
                document.querySelectorAll('.eg-delete-btn').forEach(btn => {
                    btn.addEventListener('click', function(e) {
                        ...
                        if (type === 'search') {
                            const arr = safeParse('gt_eg_searchHistory', []);
                            arr.splice(index, 1);
                            localStorage.setItem('gt_eg_searchHistory', JSON.stringify(arr));
                        } else {
                            const arr = safeParse('gt_eg_copyHistory', []);
                            arr.splice(index, 1);
