...
function categoryItemsBody(mod) {
    ...
    return `
        <div class="card cat-block">
            ...
            })).join('') : '<div class="empty-state"><span class="emoji">📝</span>还没有打卡项，去「管理 → 板块管理」添加吧</div>'}
        </div>
    `;
}
...
function otherCategoryBody(cats, mode) {
    ...
    return `
        ...
        ${!groups.length ? '<div class="empty-state"><span class="emoji">📝</span>还没有打卡项，去「管理 → 板块管理」添加吧</div>' : ''}
    `;
}

// 板块管理（「管理」Tab 下的三级子目录）：板块增删改 + 新增打卡项
function renderCheckInAdmin() {
    ...
    return `
        <div class="card">
            ...
            <div class="input-row" style="padding:0 18px 18px;gap:10px">
                <input type="text" class="input" id="newCategoryName" placeholder="输入新板块名称" style="flex:1">
                <button class="btn btn-secondary" data-action="add-category">新增板块</button>
            </div>
        </div>
        <div class="card">
...
function renderEnglish() {
    return `<div class="eg-container">
        ...
        <div class="card tab-card sub-tab-card eg-tab-bar">
            ...
            <button class="tab-btn" data-eg-tab="practice">🛠️ 练习</button>
        ...
        <div style="margin-top:16px; font-size:13px; color:#636e72; text-align:center; border-top:1px solid rgba(0,0,0,0.04); padding-top:14px;">
            🎮 把英语当成工具，越用越顺手 · 所有输出都是你的"游戏经验值"
        </div>

        </div>
        <!-- ===== practice 面板 ===== -->
        <div class="eg-panel" id="egPanel-practice">
        <!-- ===== 网格 ===== -->
        <div class="eg-grid">
...
function initEnglishPlayground() {
            ...
            function renderHistory() {
                ...
                if (currentTab === 'search') {
                    filtered = searchHistory.filter(item => item.query.toLowerCase().includes(filter));
                    ...
                    filtered.forEach((item, index) => {
                        ...
                        html += `
                            <div class="eg-history-item" data-index="${realIndex}" data-type="search">
                                <div class="eg-main">
                            ...
                            <div class="eg-history-detail" id="search-detail-${realIndex}">
                                搜索内容：${item.query}
                            </div>
                        `;
                    });
                    ...
                    filtered = copyHistory.filter(item => item.zh.includes(filter) || item.en.toLowerCase().includes(
                    filter));
                    if (filtered.length === 0) {
                        list.innerHTML =
                    ...
                    filtered.forEach((item, index) => {
                        ...
                        html += `
                            <div class="eg-history-item" data-index="${realIndex}" data-type="copy">
                                <div class="eg-main">
                                    <span class="eg-time">${time}</span>
                            ...
                            <div class="eg-history-detail" id="copy-detail-${realIndex}">
                                ${detailContent}
                            </div>
                        `;
                    });
